...
public class FlutterJNI
{
    ...
    private c3.a deferredComponentManager;
    private final Set<a$b> engineLifecycleListeners;
    private final Set<l> flutterUiDisplayListeners;
    private f localizationPlugin;
    private final Looper mainLooper;
    private Long nativeShellHolderId;
    private b3.f platformMessageHandler;
    private z platformViewsController;
    private ReentrantReadWriteLock shellHolderLock;
    
    public FlutterJNI() {
        this.shellHolderLock = new ReentrantReadWriteLock();
        this.engineLifecycleListeners = (Set<a$b>)new CopyOnWriteArraySet();
        this.flutterUiDisplayListeners = (Set<l>)new CopyOnWriteArraySet();
    ...
    public static Bitmap decodeImage(final ByteBuffer byteBuffer, final long n) {
        if (Build$VERSION.SDK_INT >= 28) {
            final ImageDecoder$Source a = io.flutter.embedding.engine.f.a(byteBuffer);
            try {
                return g.a(a, (ImageDecoder$OnHeaderDecodedListener)new k(n));
            }
            catch (final IOException ex) {
                a3.b.c("FlutterJNI", "Failed to decode image", (Throwable)ex);
            }
        }
        return null;
    }
    ...
    private void handlePlatformMessageResponse(final int n, final ByteBuffer byteBuffer) {
        final b3.f platformMessageHandler = this.platformMessageHandler;
        if (platformMessageHandler != null) {
            platformMessageHandler.d(n, byteBuffer);
        }
    }
    ...
    private native void nativeRegisterImageTexture(final long p0, final long p1, final WeakReference<TextureRegistry$ImageConsumer> p2);
    ...
    private void updateCustomAccessibilityActions(final ByteBuffer byteBuffer, final String[] array) {
        ...
        if (accessibilityDelegate != null) {
            accessibilityDelegate.b(byteBuffer, array);
        }
    }
    ...
    private void updateSemantics(final ByteBuffer byteBuffer, final String[] array, final ByteBuffer[] array2) {
        ...
        final a accessibilityDelegate = this.accessibilityDelegate;
        if (accessibilityDelegate != null) {
            accessibilityDelegate.a(byteBuffer, array, array2);
        }
    }
    
    public void addEngineLifecycleListener(final a$b a$b) {
        this.ensureRunningOnMainThread();
        this.engineLifecycleListeners.add((Object)a$b);
    }
    
    public void addIsDisplayingFlutterUiListener(final l l) {
        this.ensureRunningOnMainThread();
        this.flutterUiDisplayListeners.add((Object)l);
    }
    ...
    public FlutterOverlaySurface createOverlaySurface() {
        this.ensureRunningOnMainThread();
        final z platformViewsController = this.platformViewsController;
        if (platformViewsController != null) {
            return platformViewsController.K();
        }
    ...
    public void dispatchSemanticsAction(final int n, final k$g k$g) {
        this.dispatchSemanticsAction(n, k$g, null);
    }
    
    public void dispatchSemanticsAction(final int n, final k$g k$g, final Object o) {
        this.ensureAttachedToNative();
        ByteBuffer b;
        int position;
        if (o != null) {
        ...
        this.dispatchSemanticsAction(n, k$g.e, b, position);
    }
    ...
    public void init(final Context context, final String[] array, final String s, final String s2, final String s3, final long n) {
        if (FlutterJNI.initCalled) {
            a3.b.g("FlutterJNI", "FlutterJNI.init called more than once");
        }
    ...
    public void loadLibrary() {
        if (FlutterJNI.loadLibraryCalled) {
            a3.b.g("FlutterJNI", "FlutterJNI.loadLibrary called more than once");
        }
    ...
    public void onDisplayOverlaySurface(final int n, final int n2, final int n3, final int n4, final int n5) {
        ...
        final z platformViewsController = this.platformViewsController;
        if (platformViewsController != null) {
            platformViewsController.j0(n, n2, n3, n4, n5);
            return;
        }
        throw new RuntimeException("platformViewsController must be set before attempting to position an overlay surface");
    }
    ...
    public void onDisplayPlatformView(final int n, final int n2, final int n3, final int n4, final int n5, final int n6, final int n7, final FlutterMutatorsStack flutterMutatorsStack) {
        ...
        final z platformViewsController = this.platformViewsController;
        if (platformViewsController != null) {
            platformViewsController.k0(n, n2, n3, n4, n5, n6, n7, flutterMutatorsStack);
            return;
        }
    ...
    public void prefetchDefaultFontManager() {
        if (FlutterJNI.prefetchDefaultFontManagerCalled) {
            a3.b.g("FlutterJNI", "FlutterJNI.prefetchDefaultFontManager called more than once");
        }
        nativePrefetchDefaultFontManager();
        FlutterJNI.prefetchDefaultFontManagerCalled = true;
    }
    
    public void registerImageTexture(final long n, final TextureRegistry$ImageConsumer textureRegistry$ImageConsumer) {
        this.ensureRunningOnMainThread();
        this.ensureAttachedToNative();
        this.nativeRegisterImageTexture(this.nativeShellHolderId, n, (WeakReference<TextureRegistry$ImageConsumer>)new WeakReference((Object)textureRegistry$ImageConsumer));
    }
    ...
    public void removeEngineLifecycleListener(final a$b a$b) {
        this.ensureRunningOnMainThread();
        this.engineLifecycleListeners.remove((Object)a$b);
    }
    
    public void removeIsDisplayingFlutterUiListener(final l l) {
        this.ensureRunningOnMainThread();
        this.flutterUiDisplayListeners.remove((Object)l);
    }
    
    public void requestDartDeferredLibrary(final int n) {
        a3.b.b("FlutterJNI", "No DeferredComponentManager found. Android setup must be completed before using split AOT deferred components.");
    }
    ...
    public void setDeferredComponentManager(final c3.a a) {
        this.ensureRunningOnMainThread();
        if (a != null) {
            a.a(this);
        }
    ...
    public void setLocalizationPlugin(final f localizationPlugin) {
        this.ensureRunningOnMainThread();
        this.localizationPlugin = localizationPlugin;
    }
    
    public void setPlatformMessageHandler(final b3.f platformMessageHandler) {
        this.ensureRunningOnMainThread();
        this.platformMessageHandler = platformMessageHandler;
    }
    
    public void setPlatformViewsController(final z platformViewsController) {
        this.ensureRunningOnMainThread();
    ...
    public FlutterJNI spawn(final String s, final String s2, final String s3, final List<String> list) {
        ...
        d.a(nativeShellHolderId != null && nativeShellHolderId != 0L, (Object)"Failed to spawn new JNI connected shell from existing shell.");
        return nativeSpawn;
    }
    ...
    public interface a
    {
        void a(final ByteBuffer p0, final String[] p1, final ByteBuffer[] p2);
        
        void b(final ByteBuffer p0, final String[] p1);
    }
