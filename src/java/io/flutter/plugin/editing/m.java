...
public class m extends BaseInputConnection implements n$b
{
    ...
    private a l;
    private final m.m$a m;
    private int n;
    
    public m(final View view, final int n, final w w, final m.m$a m$a, final n n2, final EditorInfo editorInfo) {
        this(view, n, w, m$a, n2, editorInfo, new FlutterJNI());
    }
    
    public m(final View a, final int b, final w c, final m.m$a m, final n d, final EditorInfo e, final FlutterJNI flutterJNI) {
        super(a, true);
        this.g = false;
    ...
    private boolean b(int n) {
        ...
        if (n == 16908321) {
            ...
            n = Selection.getSelectionEnd((CharSequence)this.d);
            if (selectionStart2 != n) {
                ((ClipboardManager)this.a.getContext().getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText((CharSequence)"text label?", ((SpannableStringBuilder)this.d).subSequence(Math.min(selectionStart2, n), Math.max(selectionStart2, n))));
            }
            return true;
        }
        if (n == 16908322) {
    ...
    public boolean commitContent(final InputContentInfo inputContentInfo, final int n, final Bundle bundle) {
        ...
        try {
            io.flutter.plugin.editing.i.a(inputContentInfo);
            if (io.flutter.plugin.editing.j.a(inputContentInfo).getMimeTypeCount() > 0) {
                io.flutter.plugin.editing.i.a(inputContentInfo);
                final Uri a = io.flutter.plugin.editing.k.a(inputContentInfo);
                final String mimeType = io.flutter.plugin.editing.j.a(inputContentInfo).getMimeType(0);
                final Context context = this.a.getContext();
                if (a != null) {
                    try {
                        final InputStream openInputStream = context.getContentResolver().openInputStream(a);
                        if (openInputStream != null) {
                            ...
                            ((Map)hashMap).put((Object)"uri", (Object)a.toString());
                            this.c.b(this.b, (Map)hashMap);
                            io.flutter.plugin.editing.l.a(inputContentInfo);
                            return true;
                        }
                    }
    ...
    public ExtractedText getExtractedText(final ExtractedTextRequest extractedTextRequest, int n) {
        ...
        if (n == n2) {
            ...
            sb.append(s);
            a3.b.a("InputConnectionAdaptor", sb.toString());
        }
