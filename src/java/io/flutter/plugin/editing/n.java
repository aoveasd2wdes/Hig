...
class n extends SpannableStringBuilder
{
    ...
    public n(final w.e e, final View view) {
        this.e = 0;
        this.f = 0;
    ...
    public void b() {
        ++this.e;
        if (this.f > 0) {
            a3.b.b("ListenableEditingState", "editing state should not be changed in a listener callback");
        }
    ...
    public void d() {
        final int e = this.e;
        if (e == 0) {
            a3.b.b("ListenableEditingState", "endBatchEdit called without a matching beginBatchEdit");
            return;
        }
        if (e == 1) {
            ...
            if (!this.g.isEmpty()) {
                ...
                a3.b.f("ListenableEditingState", sb.toString());
    ...
    public SpannableStringBuilder replace(final int n, final int n2, final CharSequence charSequence, final int n3, final int n4) {
        ...
        this.i.add((Object)new p((CharSequence)string, n, n2, charSequence, this.i(), this.h(), this.g(), this.f()));
        if (this.e > 0) {
            return replace;
        }
    ...
    public void setSpan(final Object o, final int n, final int n2, final int n3) {
        ...
        this.i.add((Object)new p((CharSequence)this.toString(), this.i(), this.h(), this.g(), this.f()));
    }
