...
public final class p
{
    ...
    public p(final CharSequence charSequence, final int e, final int f, final int g, final int h) {
        this.e = e;
        this.f = f;
        this.g = g;
        this.h = h;
    ...
    public p(final CharSequence charSequence, final int n, final int n2, final CharSequence charSequence2, final int e, final int f, final int g, final int h) {
        this.e = e;
        this.f = f;
        this.g = g;
        this.h = h;
    ...
    public JSONObject b() {
        ...
        try {
            ...
            sb.append((Object)ex);
            a3.b.b("TextEditingDelta", sb.toString());
        }
        return jsonObject;
    }
}
