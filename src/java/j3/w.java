...
public class w
{
    ...
    public w(final b3.a a) {
        final w$a c = new w$a(this);
        this.c = (k.c)c;
        (this.a = new k((k3.c)a, "flutter/textinput", (l)k3.g.a)).e((k.c)c);
    }
    
    private static HashMap c(final ArrayList list) {
        final HashMap hashMap = new HashMap();
        final JSONArray jsonArray = new JSONArray();
        final Iterator iterator = list.iterator();
        while (iterator.hasNext()) {
            jsonArray.put((Object)((p)iterator.next()).b());
        }
        hashMap.put((Object)"deltas", (Object)jsonArray);
        return hashMap;
    }
    
    private static HashMap d(final String s, final int n, final int n2, final int n3, final int n4) {
        final HashMap hashMap = new HashMap();
    ...
    public void b(final int n, final Map map) {
        a3.b.f("TextInputChannel", "Sending 'commitContent' message.");
        this.a.c("TextInputClient.performAction", Arrays.asList(new Object[] { n, "TextInputAction.commitContent", map }));
    }
    
    public void e(final int n) {
        a3.b.f("TextInputChannel", "Sending 'done' message.");
    ...
    public void f(final int n) {
        a3.b.f("TextInputChannel", "Sending 'go' message.");
    ...
    public void g(final int n) {
        a3.b.f("TextInputChannel", "Sending 'newline' message.");
    ...
    public void h(final int n) {
        a3.b.f("TextInputChannel", "Sending 'next' message.");
    ...
    public void j(final int n) {
        a3.b.f("TextInputChannel", "Sending 'previous' message.");
    ...
    public void l(final int n) {
        a3.b.f("TextInputChannel", "Sending 'search' message.");
    ...
    public void m(final int n) {
        a3.b.f("TextInputChannel", "Sending 'send' message.");
    ...
    public void o(final int n) {
        a3.b.f("TextInputChannel", "Sending 'unspecified' message.");
    ...
    public void p(final int n, final String s, final int n2, final int n3, final int n4, final int n5) {
        ...
        sb.append("\nComposing end: ");
        sb.append(n5);
        a3.b.f("TextInputChannel", sb.toString());
    ...
    public void q(final int n, final ArrayList list) {
        final StringBuilder sb = new StringBuilder();
    ...
    public void r(final int n, final HashMap hashMap) {
        final StringBuilder sb = new StringBuilder();
    ...
    public static class b
    {
        ...
        public static b a(final JSONObject jsonObject) {
            ...
            if (string != null) {
                ...
                final d b2 = d.b(jsonObject.getString("textCapitalization"));
                ...
                return new b(optBoolean, optBoolean2, optBoolean3, optBoolean4, optBoolean5, b2, a2, b, string2, a3, (String[])((List)list).toArray((Object[])new String[((List)list).size()]), array);
            }
    ...
    public enum d
    {
        f("CHARACTERS", 0, "TextCapitalization.characters"), 
        g("WORDS", 1, "TextCapitalization.words"), 
        h("SENTENCES", 2, "TextCapitalization.sentences"), 
        i("NONE", 3, "TextCapitalization.none");
    ...
    public interface f
    {
        ...
        void d(final int p0, final b p1);
        
        void e(final int p0, final boolean p1);
        
        void f(final double p0, final double p1, final double[] p2);
    ...
    public enum g
    {
        f("TEXT", 0, "TextInputType.text"), 
        g("DATETIME", 1, "TextInputType.datetime"), 
        h("NAME", 2, "TextInputType.name"), 
        i("POSTAL_ADDRESS", 3, "TextInputType.address"), 
        j("NUMBER", 4, "TextInputType.number"), 
        k("PHONE", 5, "TextInputType.phone"), 
        l("MULTILINE", 6, "TextInputType.multiline"), 
        m("EMAIL_ADDRESS", 7, "TextInputType.emailAddress"), 
        n("URL", 8, "TextInputType.url"), 
        o("VISIBLE_PASSWORD", 9, "TextInputType.visiblePassword"), 
        p("NONE", 10, "TextInputType.none");
        ...
        private static /* synthetic */ g[] a() {
            return new g[] { g.f, g.g, g.h, g.i, g.j, g.k, g.l, g.m, g.n, g.o, g.p };
        }
