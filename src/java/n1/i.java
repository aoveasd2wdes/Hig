...
public class i
{
    ...
    public Intent a(final Context context, final int n, String string) {
        if (n != 1 && n != 2) {
            if (n != 3) {
                return null;
            }
    ...
    public PendingIntent c(final Context context, final int n, final int n2, final String s) {
        ...
        return PendingIntent.getActivity(context, n2, a, a2.d.a | 0x8000000);
    }
    ...
    public int f(final Context context) {
        return this.g(context, i.a);
    }
    
    public int g(final Context context, int d) {
        d = l.d(context, d);
        if (l.e(context, d)) {
            return 18;
        }
