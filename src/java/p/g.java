...
public class g
{
    ...
    public boolean equals(Object m) {
        ...
        try {
            while (l < this.g) {
                final Object i2 = this.i(l);
                m = this.m(l);
                final Object value2 = map.get(i2);
                if (m == null) {
                    if (value2 != null || !map.containsKey(i2)) {
                        return false;
                    }
                }
    ...
    public void j(final g g) {
        ...
        if (g3 == 0) {
            if (g2 > 0) {
                System.arraycopy((Object)g.e, 0, (Object)this.e, 0, g2);
                System.arraycopy((Object)g.f, 0, (Object)this.f, 0, g2 << 1);
                this.g = g2;
            }
        }
        else {
