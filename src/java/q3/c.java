...
class c
{
    ...
    void d(final r.g g) {
        ...
        if (g.c() != null) {
            edit.putLong("flutter_image_picker_max_width", Double.doubleToRawLongBits((double)g.c()));
        }
        if (g.b() != null) {
            edit.putLong("flutter_image_picker_max_height", Double.doubleToRawLongBits((double)g.b()));
        }
        edit.putInt("flutter_image_picker_image_quality", g.d().intValue());
        edit.apply();
    }
    ...
    void f(final ArrayList list, final String s, final String s2) {
        final SharedPreferences$Editor edit = this.a.getSharedPreferences("flutter_image_picker_shared_preference", 0).edit();
        if (list != null) {
