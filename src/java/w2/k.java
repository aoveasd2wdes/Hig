...
class k
{
    ...
    k(final Context e, final String b, final int c, final boolean a, final int d) {
    ...
    private void S(final e e, final Runnable runnable) {
        ...
        else if (h != null && (h.equals((Object)l) || h == -1)) {
            runnable.run();
            if (this.l == null && !this.f.isEmpty()) {
                this.h.c(this, (Runnable)new j(this));
            }
        }
        else {
    ...
    private void l(final int n) {
        final v v = (v)this.g.get((Object)n);
        if (v != null) {
            this.m(v);
        }
    }
    
    private void m(final v v) {
        try {
            final int a = v.a;
            if (t.c(this.d)) {
    ...
    private Map n(final Cursor cursor, final Integer n) {
        Map map = null;
        List list = null;
        int n2 = 0;
        Object o;
        while (true) {
            ...
            ((List)o2).add((Object)g0.a(cursor, columnCount));
            map = (Map)o;
            list = (List)o2;
            n2 = columnCount;
            if (n == null) {
    ...
    private boolean q(final e p0) {
        ...
        // 
        //     1: aload_1        
        //     2: invokespecial   w2/k.w:(Ly2/e;)Z
        //     5: ifne            10
        //     8: iconst_0       
        //     9: ireturn        
        //    10: aload_1        
        //    11: invokeinterface y2/e.e:()Z
        //    16: istore_2       
        //    17: aconst_null    
        //    18: astore          5
        //    20: iload_2        
        ...
        //    24: aload_1        
        //    25: aconst_null    
        //    26: invokeinterface y2/f.a:(Ljava/lang/Object;)V
        //    31: iconst_1       
        //    32: ireturn        
        //    33: aload_0        
        //    34: invokevirtual   w2/k.C:()Landroid/database/sqlite/SQLiteDatabase;
        ...
        //    96: astore          5
        //    98: aload_0        
        //    99: getfield        w2/k.d:I
        //   102: invokestatic    w2/t.b:(I)Z
        //   105: ifeq            200
        //   108: aload           6
        //   110: astore          5
        ...
        //   130: aload           7
        //   132: aload_0        
        //   133: invokevirtual   w2/k.A:()Ljava/lang/String;
        ...
        //   204: aload_1        
        //   205: aconst_null    
        //   206: invokeinterface y2/f.a:(Ljava/lang/Object;)V
        //   211: aload           6
        ...
        //   235: astore          5
        //   237: aload_0        
        //   238: getfield        w2/k.d:I
        //   241: invokestatic    w2/t.b:(I)Z
        //   244: ifeq            319
        //   247: aload           6
        //   249: astore          5
        ...
        //   269: aload           7
        //   271: aload_0        
        //   272: invokevirtual   w2/k.A:()Ljava/lang/String;
        ...
        //   328: invokeinterface y2/f.a:(Ljava/lang/Object;)V
        //   333: aload           6
        ...
        //   369: aload           7
        //   371: aload_0        
        //   372: invokevirtual   w2/k.A:()Ljava/lang/String;
        ...
        //   412: aload_1        
        //   413: aconst_null    
        //   414: invokeinterface y2/f.a:(Ljava/lang/Object;)V
        //   419: aload           6
        //   421: ifnull          431
        //   424: aload           6
        ...
        //   447: aload           7
        //   449: aload_1        
        //   450: invokevirtual   w2/k.D:(Ljava/lang/Exception;Ly2/e;)V
        //   453: aload           6
        //   455: ifnull          465
        //   458: aload           6
    ...
    private boolean r(final e p0) {
        ...
        //     4: invokeinterface y2/e.c:(Ljava/lang/String;)Ljava/lang/Object;
        //     9: checkcast       Ljava/lang/Integer;
        //    12: astore          10
        //    14: aload_1        
        //    15: invokeinterface y2/e.d:()Lw2/f0;
        //    20: astore          5
        //    22: aload_0        
        //    23: getfield        w2/k.d:I
        //    26: invokestatic    w2/t.b:(I)Z
        //    29: ifeq            67
        ...
        //    40: aload_3        
        //    41: aload_0        
        //    42: invokevirtual   w2/k.A:()Ljava/lang/String;
        ...
        //    79: astore          4
        //    81: aload_0        
        //    82: invokevirtual   w2/k.z:()Landroid/database/sqlite/SQLiteDatabase;
        //    85: astore          11
        //    87: new             Lw2/h;
        //    90: astore          7
        //    92: aload           7
        //    94: aload           5
        //    96: invokespecial   w2/h.<init>:(Lw2/f0;)V
        //    99: aload           11
        //   101: aload           7
        //   103: aload           5
        //   105: invokevirtual   w2/f0.c:()Ljava/lang/String;
        //   108: getstatic       w2/a.a:[Ljava/lang/String;
        //   111: aconst_null    
        ...
        //   129: aload           5
        //   131: aload           10
        //   133: invokespecial   w2/k.n:(Landroid/database/Cursor;Ljava/lang/Integer;)Ljava/util/Map;
        //   136: astore          11
        //   138: aload           10
        //   140: ifnull          190
        //   143: aload           9
        ...
        //   291: aload           5
        //   293: invokespecial   w2/v.<init>:(IILandroid/database/Cursor;)V
        //   296: aload_0        
        //   297: getfield        w2/k.g:Ljava/util/Map;
        //   300: iload_2        
        ...
        //   338: aload_1        
        //   339: aload           11
        //   341: invokeinterface y2/f.a:(Ljava/lang/Object;)V
        //   346: aload           4
        //   348: ifnonnull       363
        //   351: aload           5
        //   353: ifnull          363
        ...
        //   398: aload           8
        //   400: aload_1        
        //   401: invokevirtual   w2/k.D:(Ljava/lang/Exception;Ly2/e;)V
        //   404: aload           4
        //   406: ifnull          422
        //   409: aload           5
        //   411: astore          6
        ...
        //   416: aload_0        
        //   417: aload           4
        //   419: invokespecial   w2/k.m:(Lw2/v;)V
        //   422: aload           4
        //   424: ifnonnull       439
        //   427: aload           5
        //   429: ifnull          439
    ...
    private boolean s(final e p0) {
        ...
        //    20: aload_1        
        //    21: ldc_w           "cancel"
        //    24: invokeinterface y2/e.c:(Ljava/lang/String;)Ljava/lang/Object;
        //    29: invokevirtual   java/lang/Boolean.equals:(Ljava/lang/Object;)Z
        //    32: istore          5
        //    34: aload_0        
        //    35: getfield        w2/k.d:I
        //    38: invokestatic    w2/t.c:(I)Z
        //    41: ifeq            118
        ...
        //    53: aload           7
        //    55: aload_0        
        //    56: invokevirtual   w2/k.A:()Ljava/lang/String;
        ...
        //   126: aload_0        
        //   127: iload           4
        //   129: invokespecial   w2/k.l:(I)V
        //   132: aload_1        
        //   133: aconst_null    
        //   134: invokeinterface y2/f.a:(Ljava/lang/Object;)V
        //   139: iconst_1       
        //   140: ireturn        
        //   141: aload_0        
        //   142: getfield        w2/k.g:Ljava/util/Map;
        //   145: iload           4
        ...
        //   164: ifnull          281
        //   167: aload           7
        //   169: getfield        w2/v.c:Landroid/database/Cursor;
        //   172: astore          6
        //   174: aload_0        
        //   175: aload           6
        //   177: aload           7
        //   179: getfield        w2/v.b:I
        //   182: invokestatic    java/lang/Integer.valueOf:(I)Ljava/lang/Integer;
        //   185: invokespecial   w2/k.n:(Landroid/database/Cursor;Ljava/lang/Integer;)Ljava/util/Map;
        //   188: astore          9
        //   190: aload           6
        ...
        //   245: aload_1        
        //   246: aload           9
        //   248: invokeinterface y2/f.a:(Ljava/lang/Object;)V
        //   253: iload_2        
        //   254: ifne            263
        //   257: aload_0        
        //   258: aload           7
        //   260: invokespecial   w2/k.m:(Lw2/v;)V
        //   263: iconst_1       
        //   264: ireturn        
        //   265: astore          6
        //   267: goto            335
        ...
        //   338: aload           6
        //   340: aload_1        
        //   341: invokevirtual   w2/k.D:(Ljava/lang/Exception;Ly2/e;)V
        //   344: aload           7
        //   346: ifnull          363
        //   349: iload_2        
        //   350: istore_3       
        //   351: aload_0        
        //   352: aload           7
        //   354: invokespecial   w2/k.m:(Lw2/v;)V
        //   357: aload           8
        //   359: astore_1       
        //   360: goto            366
        //   363: aload           7
        ...
        //   374: aload_0        
        //   375: aload_1        
        //   376: invokespecial   w2/k.m:(Lw2/v;)V
        //   379: iconst_0       
        //   380: ireturn        
        //   381: astore_1       
        //   382: iload_3        
        ...
        //   393: aload_0        
        //   394: aload           7
        //   396: invokespecial   w2/k.m:(Lw2/v;)V
        //   399: aload_1        
        //   400: athrow         
        //    Exceptions:
        //  Try           Handler
    ...
    void D(final Exception ex, final e e) {
        ...
        ((y2.f)e).b("sqlite_error", s, a);
    }
    
    public void E(final e e) {
        this.S(e, (Runnable)new f(this, e));
    }
    ...
    public void M() {
        if (w2.k.n == null && (w2.k.n = j(this.e)) && t.c(this.d)) {
            final StringBuilder sb = new StringBuilder();
            sb.append(this.A());
    ...
    public void O(final e e) {
        this.S(e, (Runnable)new w2.g(this, e));
    }
    ...
    public void R(final e e) {
        this.S(e, (Runnable)new i(this, e));
    }
    
    void h(final k3.j j, final k$d k$d) {
        final y2.d d = new y2.d(j, k$d);
        final boolean e = ((y2.b)d).e();
        final boolean l = ((y2.b)d).l();
        final List list = (List)d.c("operations");
        final ArrayList list2 = new ArrayList();
        final Iterator iterator = list.iterator();
        while (iterator.hasNext()) {
            final y2.c c = new y2.c((Map)iterator.next(), e);
            final String g = c.g();
            g.hashCode();
    ...
    public void v(final e e) {
        this.S(e, (Runnable)new w2.e(this, e));
    }
